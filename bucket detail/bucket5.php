...
<body>
    ...
    <section id="bucket-details">
        <div class="bucket-image">
            <img src="img/bucket5.png" alt="Beautiful Flower 1">
        </div>
        <div class="bucket-description">
            <h2>Bucket 5</h2>
            <p>This arrangement includes fresh roses, lilies, and greenery, perfect for any occasion. It's a beautiful and thoughtful gift for loved ones, or a great addition to your home decor.</p>
            <h3>$29.99</h3>
        </div>
